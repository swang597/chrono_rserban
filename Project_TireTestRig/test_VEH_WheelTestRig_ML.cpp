...
class TerrainForceLoader : public ChLoadContainer {
  public:
    ...
    std::shared_ptr<hmmwv::HMMWV_Wheel> wheel, 
        ...
        m_I_min_max = loadFromTxt(fn_dataPT + "I_min_max.txt");
        m_dI_min_max = loadFromTxt(fn_dataPT + "dI_min_max.txt");
        m_F_min_max = loadFromTxt(fn_dataPT + "F_min_max.txt");
        m_dF_min_max = loadFromTxt(fn_dataPT + "dF_min_max.txt");
        m_Vec_min_max = loadFromTxt(fn_dataPT + "Vec_min_max.txt");
...
int main(int argc, char *argv[]) {
    ...
    std::string output_folderpath =    out_dir + "_HMbmp_2Terr/";
    ...
    auto terrain = chrono_types::make_shared<TerrainForceLoader>(folderpath_normlized,
    ...
    // rig.Initialize(ChTireTestRig::Mode::TEST, false); //Shu added
