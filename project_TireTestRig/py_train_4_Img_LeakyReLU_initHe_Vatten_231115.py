...
if NN_idx == 1:
    ...
    model = mymodel.UNet_LeakyReLU_CNN3e3d_lin6_Vatten_V(img_channel_NN1, img_rowsize, img_colsize, vec_nfeature_in, Ksize, padding, poolSize1, poolSize2, vec_nfeature_out)
    NN_keyword = 'vec'
...
folder_model_wheel = f"Model/Model_2stepNN_iDT{nDT}_img{img_rowsize}by{img_colsize}_{today_str}_flag_usePredI{flag_usePredI}_LeakyReLU_Vatten/"
