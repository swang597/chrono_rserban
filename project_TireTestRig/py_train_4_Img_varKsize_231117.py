...
# read dataset ----------
fn_dataset_train = f"/home/swang597/Documents/Research/chrono_fork_radu/project_TireTestRig/build/DEMO_OUTPUT/Dataset_4_ML_train_diffLoad_231119/"
fn_dataset_test = f"/home/swang597/Documents/Research/chrono_fork_radu/project_TireTestRig/build/DEMO_OUTPUT/Dataset_4_ML_test_diffLoad_231119/"
...
folder_model_wheel = f"Model/Model_2stepNN_iDT{nDT}_img{img_rowsize}by{img_colsize}_varKsize{''.join([str(i) for i in Ksize])}_{today_str}/"
...
if NN_idx == 1:
    if flag_usePredI:
        model_Img = mymodel.UNet_CNN3e3d_IV_I(img_channel_NN2, img_rowsize, img_colsize, vec_nfeature_in, Ksize, Ksize//2, poolSize1, poolSize2)
    ...
    # model = mymodel.UNet_CNN3e3d_lin6_V(img_channel_NN1, img_rowsize, img_colsize, vec_nfeature_in, Ksize, padding, poolSize1, poolSize2, vec_nfeature_out)
    # NN_keyword = 'vec'
    ...
    if len(Ksize) == 2:
        model = mymodel.UNet_CNN2e2d_varKsize_IV_I(img_channel_NN2, img_rowsize, img_colsize, vec_nfeature_in, Ksize, poolSize1, poolSize2)
    elif len(Ksize) == 3:
        model = mymodel.UNet_CNN3e3d_varKsize_IV_I(img_channel_NN2, img_rowsize, img_colsize, vec_nfeature_in, Ksize, poolSize1, poolSize2)
    elif len(Ksize) == 4:
        model = mymodel.UNet_CNN4e4d_varKsize_IV_I(img_channel_NN2, img_rowsize, img_colsize, vec_nfeature_in, Ksize, poolSize1, poolSize2)
