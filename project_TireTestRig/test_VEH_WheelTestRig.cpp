...
int main(int argc, char *argv[]) {
    ...
    double heightmap_cutoff_y_left = 0.15; // cylinder wheel width 0.128*2
    double heightmap_cutoff_y_right = 0.15; 
    double heightmap_cutoff_x_backward = 0.24; // cylinder wheel radius 0.208
    double heightmap_cutoff_x_forward = 0.18;
