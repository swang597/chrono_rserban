...
int main(int argc, char* argv[]) {
    ...
    app.AddCamera(irr::core::vector3df(0, -1, 0.2f), irr::core::vector3dfCH(init_loc));
    ...
    while (app.GetDevice()->run()) {
        ...
        std::cout << "   point:  " << tire_force_report.point.x() << "  " << tire_force_report.point.y() << "  "
                  << tire_force_report.point.z() << std::endl;
        std::cout << "   force:  " << tire_force_report.force.x() << "  " << tire_force_report.force.y() << "  "
                  << tire_force_report.force.z() << std::endl;
        std::cout << "   moment: " << tire_force_report.moment.x() << "  " << tire_force_report.moment.y() << "  "
                  << tire_force_report.moment.z() << std::endl;
