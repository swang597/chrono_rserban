...
int main(int argc, char* argv[]) {
...
#ifdef USE_SMC
    my_system->GetSettings()->solver.contact_force_model = ChSystemSMC::ContactForceModel::Hertz;  // TODO Hooke
    ...
    auto plate =
        chrono_types::make_shared<ChBody>(ChCollisionSystemType::CHRONO);
