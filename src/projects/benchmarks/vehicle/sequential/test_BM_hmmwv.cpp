...
class HmmwvAcc : public utils::ChBenchmarkTest {
public:
    HmmwvAcc();
    ~HmmwvAcc();

    ChSystem* GetSystem() override { return m_hmmwv->GetVehicle().GetSystem(); }
...
private:
    ...
    static const double m_step_veh;
    static const double m_step_tire;
};

const double HmmwvAcc::m_step_veh = 1e-3;
const double HmmwvAcc::m_step_tire = 1e-3;
...
CH_BM_SIMULATION(Hmmwv, HmmwvAcc, NUM_SKIP_STEPS, NUM_SIM_STEPS, 20);
