...
CH_BM_SIMULATION(MixerSMC032, MixerTestSMC<32>,  NUM_SKIP_STEPS, NUM_SIM_STEPS, 10);
CH_BM_SIMULATION(MixerSMC064, MixerTestSMC<64>,  NUM_SKIP_STEPS, NUM_SIM_STEPS, 10);
CH_BM_SIMULATION(MixerSMC128, MixerTestSMC<128>, NUM_SKIP_STEPS, NUM_SIM_STEPS, 10);
CH_BM_SIMULATION(MixerSMC256, MixerTestSMC<256>, NUM_SKIP_STEPS, NUM_SIM_STEPS, 10);
CH_BM_SIMULATION(MixerSMC512, MixerTestSMC<512>, NUM_SKIP_STEPS, NUM_SIM_STEPS, 10);
