...
void create_objects(ChSystemMulticoreNSC& sys);
void output_frame_ascii(ChSystemMulticoreNSC& sys, int frame, std::ofstream& file);
void output_frame_hdf5(ChSystemMulticoreNSC& sys, int frame, H5::H5File& file);
...
int main(int argc, char* argv[]) {
    ...
    gl_window.Initialize(1280, 720, "HDF5 multicore", &sys);
