...
class CH_VEHICLE_API ChTireTestRig2Wheels {
  public:
    ...
    // void Initialize(Mode mode, bool createTerrain); //Shu
    void Initialize(Mode mode, double terrain_grid); //Shu
    void Initialize(Mode mode, double terrain_grid, double terrain_initX, double terrain_initH); //Shu
    ...
    void Advance_ML(double step); //Shu
    /// Get total rig mass.
  ...
  private:
    ...
    void CreateTerrain(double terrain_grid, double terrain_initX, double terrain_initH); //Shu
    void CreateTerrain(const std::string& heightmap_file,
            double sizeX, double sizeY, double hMin, double hMax, double terrain_grid, double terrain_initX, double terrain_initH); //Shu
    void CreateTerrainSCM();
    void CreateTerrainSCM(double terrain_grid); //Shu
    void CreateTerrainSCM(double terrain_grid, double terrain_initX, double terrain_initH); //Shu
