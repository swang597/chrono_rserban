...
namespace vehicle
{
    ...
    public:
        ...
        {
            return ChVector<>(m_states.xe, m_states.ye, m_data.depth);
        }
    ...
    protected:
        ...
        {
            return w1 + (w2 - w1) * (fz / m_TMeasyCoeff.pn - 1.0);
        };
