...
class CH_VEHICLE_API ChToeBarGAxleSimple : public ChSuspension {
  ...
  protected:
    ...
    /// Return the moments of inertia of panhard rod tube body.
    ...
    std::shared_ptr<ChLinkLockSpherical> m_panhardAxle;
    std::shared_ptr<ChLinkLockSpherical> m_panhardChassis;
  ...
  private:
    ...
    ChVector<> m_posPanhardRodAxle;
    ChVector<> m_posPanhardRodChassis;
