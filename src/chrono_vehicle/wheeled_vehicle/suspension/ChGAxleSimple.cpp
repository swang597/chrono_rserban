...
void ChGAxleSimple::Initialize(std::shared_ptr<ChChassis> chassis,
    ...
    ChVector<> panhardCOM = (m_posPanhardRodAxle + m_posPanhardRodChassis) / 2;
    ...
    m_panhardChassis->Initialize(chassis->GetBody(), m_panhardRod, ChCoordsys<>(m_posPanhardRodChassis));
    ...
    m_panhardAxle->Initialize(m_axleTube, m_panhardRod, ChCoordsys<>(m_posPanhardRodAxle));
...
// -----------------------------------------------------------------------------
ChVector<> ChGAxleSimple::GetCOMPos() const {
    ChVector<> com(0, 0, 0);
...
// -----------------------------------------------------------------------------
ChSuspension::Force ChGAxleSimple::ReportSuspensionForce(VehicleSide side) const {
...
void ChGAxleSimple::ExportComponentList(rapidjson::Document& jsonDocument) const {
    ...
    joints.push_back(m_panhardChassis);
    joints.push_back(m_panhardAxle);
