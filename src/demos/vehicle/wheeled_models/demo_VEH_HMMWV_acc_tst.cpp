...
double terrainLength = 800.0;  // size in X direction
...
int main(int argc, char* argv[]) {
    ...
    switch (tire_model) {
        case TireModelType::RIGID:
            driver_csv.write_to_file("test_hmmwv_rigid.csv", "#time throttle speed engine_torque engine_speed\n");
            break;
        case TireModelType::TMEASY:
            driver_csv.write_to_file("test_hmmwv_tmeasy.csv", "#time throttle speed engine_torque engine_speed\n");
            break;
        case TireModelType::PAC89:
            driver_csv.write_to_file("test_hmmwv_pac89.csv", "#time throttle speed engine_torque engine_speed\n");
            break;
        case TireModelType::PAC02:
            driver_csv.write_to_file("test_hmmwv_pac02.csv", "#time throttle speed engine_torque engine_speed\n");
            break;
    }
    return 0;
}
