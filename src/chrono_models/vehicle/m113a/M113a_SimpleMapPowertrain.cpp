...
M113a_SimpleMapPowertrain::M113a_SimpleMapPowertrain(const std::string& name) : ChSimpleMapPowertrain(name) {}

double M113a_SimpleMapPowertrain::GetMaxEngineSpeed() {
    return 3500 * rpm2rads;
}

void M113a_SimpleMapPowertrain::SetEngineTorqueMaps(ChFunction_Recorder& map0, ChFunction_Recorder& mapF) {
...
void M113a_SimpleMapPowertrain::SetGearRatios(std::vector<double>& fwd, double& rev) {
    rev = -0.151;
...
void M113a_SimpleMapPowertrain::SetShiftPoints(std::vector<std::pair<double, double>>& shift_bands) {
