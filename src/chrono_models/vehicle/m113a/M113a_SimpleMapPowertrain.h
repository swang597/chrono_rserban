...
#ifndef M113a_SIMPLEMAP_POWERTRAIN_H
#define M113a_SIMPLEMAP_POWERTRAIN_H
...
class CH_MODELS_API M113a_SimpleMapPowertrain : public ChSimpleMapPowertrain {
  public:
    M113a_SimpleMapPowertrain(const std::string& name);
