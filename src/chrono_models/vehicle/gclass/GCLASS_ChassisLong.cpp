...
// Static variables
// -----------------------------------------------------------------------------
const double GCLASS_ChassisLong::m_body_mass = 2354.0;
const ChVector<> GCLASS_ChassisLong::m_body_inertiaXX(785.0, 2612.0, 2761.0);
const ChVector<> GCLASS_ChassisLong::m_body_inertiaXY(0, 0, 0);
const ChVector<> GCLASS_ChassisLong::m_body_COM_loc(-1.65, 0.0, 0.3);
const ChVector<> GCLASS_ChassisLong::m_connector_rear_loc(-3.95, 0, -0.05);
const ChCoordsys<> GCLASS_ChassisLong::m_driverCsys(ChVector<>(-1.1, 0.7, 0.5), ChQuaternion<>(1, 0, 0, 0));

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
GCLASS_ChassisLong::GCLASS_ChassisLong(const std::string& name, bool fixed, CollisionType chassis_collision_type)
