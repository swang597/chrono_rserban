...
#include "chrono_models/vehicle/gclass/GCLASS_VehicleLong.h"
#include "chrono_models/vehicle/gclass/GCLASS_BrakeSimple.h"
#include "chrono_models/vehicle/gclass/GCLASS_BrakeShafts.h"
#include "chrono_models/vehicle/gclass/GCLASS_ChassisLong.h"
#include "chrono_models/vehicle/gclass/GCLASS_Driveline4WD.h"
#include "chrono_models/vehicle/gclass/GCLASS_RearAxle.h"
#include "chrono_models/vehicle/gclass/GCLASS_RotaryArm.h"
#include "chrono_models/vehicle/gclass/GCLASS_FrontAxle.h"
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
GCLASS_VehicleLong::GCLASS_VehicleLong(const bool fixed,
...
GCLASS_VehicleLong::GCLASS_VehicleLong(ChSystem* system,
                               const bool fixed,
                               BrakeType brake_type,
                               SteeringTypeWV steering_model,
                               CollisionType chassis_collision_type)
...
void GCLASS_VehicleLong::Create(bool fixed,
                            BrakeType brake_type,
                            SteeringTypeWV steering_model,
                            CollisionType chassis_collision_type) {
    // Create the chassis subsystem
    m_chassis = chrono_types::make_shared<GCLASS_ChassisLong>("Chassis", fixed, chassis_collision_type);

    // Create the steering subsystem
    m_steerings.resize(1);
    m_steerings[0] = chrono_types::make_shared<GCLASS_RotaryArm>("Steering");
    ...
    m_axles[0]->m_suspension = chrono_types::make_shared<GCLASS_FrontAxle>("FrontSusp");
    m_axles[1]->m_suspension = chrono_types::make_shared<GCLASS_RearAxle>("RearSusp");

    m_axles[0]->m_wheels.resize(2);
    m_axles[0]->m_wheels[0] = chrono_types::make_shared<GCLASS_Wheel>("Wheel_FL");
    m_axles[0]->m_wheels[1] = chrono_types::make_shared<GCLASS_Wheel>("Wheel_FR");
    m_axles[1]->m_wheels.resize(2);
    m_axles[1]->m_wheels[0] = chrono_types::make_shared<GCLASS_Wheel>("Wheel_RL");
    m_axles[1]->m_wheels[1] = chrono_types::make_shared<GCLASS_Wheel>("Wheel_RR");

    switch (brake_type) {
        case BrakeType::SIMPLE:
            m_axles[0]->m_brake_left = chrono_types::make_shared<GCLASS_BrakeSimpleFront>("Brake_FL");
            m_axles[0]->m_brake_right = chrono_types::make_shared<GCLASS_BrakeSimpleFront>("Brake_FR");
            m_axles[1]->m_brake_left = chrono_types::make_shared<GCLASS_BrakeSimpleFront>("Brake_RL");
            m_axles[1]->m_brake_right = chrono_types::make_shared<GCLASS_BrakeSimpleFront>("Brake_RR");
            break;
        case BrakeType::SHAFTS:
            m_axles[0]->m_brake_left = chrono_types::make_shared<GCLASS_BrakeShaftsFront>("Brake_FL");
            m_axles[0]->m_brake_right = chrono_types::make_shared<GCLASS_BrakeShaftsFront>("Brake_FR");
            m_axles[1]->m_brake_left = chrono_types::make_shared<GCLASS_BrakeShaftsFront>("Brake_RL");
            m_axles[1]->m_brake_right = chrono_types::make_shared<GCLASS_BrakeShaftsFront>("Brake_RR");
            break;
    }

    // Create the driveline
    m_driveline = chrono_types::make_shared<GCLASS_Driveline4WD>("Driveline");
    ////m_driveline = chrono_types::make_shared<GCLASS_SimpleDriveline>("Driveline");
}

GCLASS_VehicleLong::~GCLASS_VehicleLong() {}

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void GCLASS_VehicleLong::Initialize(const ChCoordsys<>& chassisPos, double chassisFwdVel) {
...
// -----------------------------------------------------------------------------
void GCLASS_VehicleLong::LogHardpointLocations() {
...
// -----------------------------------------------------------------------------
void GCLASS_VehicleLong::DebugLog(int what) {
