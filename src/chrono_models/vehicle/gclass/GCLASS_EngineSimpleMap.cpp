...
GCLASS_EngineSimpleMap::GCLASS_EngineSimpleMap(const std::string& name) : ChEngineSimpleMap(name) {}

double GCLASS_EngineSimpleMap::GetMaxEngineSpeed() {
    return 3900 * rpm2rads;
}

void GCLASS_EngineSimpleMap::SetEngineTorqueMaps(ChFunction_Recorder& map0, ChFunction_Recorder& mapF) {
