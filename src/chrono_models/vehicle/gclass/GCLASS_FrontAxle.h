...
#ifndef GCLASS_FRONT_AXLE_H
#define GCLASS_FRONT_AXLE_H
...
class CH_MODELS_API GCLASS_FrontAxle : public ChToeBarRigidPanhardAxle {
  public:
    GCLASS_FrontAxle(const std::string& name);
    ~GCLASS_FrontAxle();
