...
#ifndef GCLASS_LONG_H
#define GCLASS_LONG_H
...
#include "chrono_models/vehicle/gclass/GCLASS_EngineSimpleMap.h"
#include "chrono_models/vehicle/gclass/GCLASS_AutomaticTransmissionSimpleMap.h"
#include "chrono_models/vehicle/gclass/GCLASS_RigidTire.h"
...
class CH_MODELS_API GCLASS_Long {
  public:
    GCLASS_Long();
    GCLASS_Long(ChSystem* system);
