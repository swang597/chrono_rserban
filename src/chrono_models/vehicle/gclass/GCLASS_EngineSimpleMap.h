...
#ifndef GCLASS_ENGINE_SIMPLEMAP_H
#define GCLASS_ENGINE_SIMPLEMAP_H
...
class CH_MODELS_API GCLASS_EngineSimpleMap : public ChEngineSimpleMap {
  public:
    GCLASS_EngineSimpleMap(const std::string& name);
