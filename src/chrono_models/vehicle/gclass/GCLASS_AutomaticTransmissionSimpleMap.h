...
#ifndef GCLASS_AUTOMATIC_TRANSMISSION_SIMPLE_MAP_H
#define GCLASS_AUTOMATIC_TRANSMISSION_SIMPLE_MAP_H
...
class CH_MODELS_API GCLASS_AutomaticTransmissionSimpleMap : public ChAutomaticTransmissionSimpleMap {
  public:
    GCLASS_AutomaticTransmissionSimpleMap(const std::string& name);
