...
// Static variables
// -----------------------------------------------------------------------------
const double GCLASS_Chassis::m_body_mass = 2254.0;
const ChVector<> GCLASS_Chassis::m_body_inertiaXX(785.0, 2612.0, 2761.0);
const ChVector<> GCLASS_Chassis::m_body_inertiaXY(0, 0, 0);
const ChVector<> GCLASS_Chassis::m_body_COM_loc(-1.422, 0.0, 0.3);
const ChVector<> GCLASS_Chassis::m_connector_rear_loc(-3.5, 0, -0.05);
const ChCoordsys<> GCLASS_Chassis::m_driverCsys(ChVector<>(-1.1, 0.7, 0.5), ChQuaternion<>(1, 0, 0, 0));

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
GCLASS_Chassis::GCLASS_Chassis(const std::string& name, bool fixed, CollisionType chassis_collision_type)
    ...
    m_geometry.m_vis_mesh_file = "gclass/GCLASS_Chassis.obj";
    ...
    switch (chassis_collision_type) {
        ...
        case CollisionType::HULLS: {
            ChVehicleGeometry::ConvexHullsShape hull("gclass/GCLASS_Chassis_simple.obj", 0);
