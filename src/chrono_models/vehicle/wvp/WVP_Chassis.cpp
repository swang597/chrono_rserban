...
// Static variables
// -----------------------------------------------------------------------------
const double WVP_Chassis::m_mass = 8935.762; //this is entire vehicle with payload
...
const ChCoordsys<> WVP_Chassis::m_driverCsys(ChVector<>(-1.8,.7,.495), ChQuaternion<>(1, 0, 0, 0));
