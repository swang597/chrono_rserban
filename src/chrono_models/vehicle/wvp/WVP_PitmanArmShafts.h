...
#ifndef WVP_PITMAN_ARM_SHAFTS_H
#define WVP_PITMAN_ARM_SHAFTS_H
...
class CH_MODELS_API WVP_PitmanArmShafts : public ChPitmanArmShafts {
  public:
    WVP_PitmanArmShafts(const std::string& name, bool rigid_connection);
    ~WVP_PitmanArmShafts() {}
