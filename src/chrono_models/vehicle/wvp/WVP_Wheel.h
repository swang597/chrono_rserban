...
class CH_MODELS_API WVP_WheelLeft : public WVP_Wheel {
  public:
    WVP_WheelLeft(const std::string& name);
    ~WVP_WheelLeft() {}
...
class CH_MODELS_API WVP_WheelRight : public WVP_Wheel {
  public:
    WVP_WheelRight(const std::string& name);
    ~WVP_WheelRight() {}
