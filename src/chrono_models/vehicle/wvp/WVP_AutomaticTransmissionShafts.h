...
#ifndef WVP_AUTOMATIC_TRANSMISSION_H
#define WVP_AUTOMATIC_TRANSMISSION_H
...
class CH_MODELS_API WVP_AutomaticTransmissionShafts : public ChAutomaticTransmissionShafts {
  public:
    WVP_AutomaticTransmissionShafts();
    ~WVP_AutomaticTransmissionShafts() {}
