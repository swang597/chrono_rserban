...
// =============================================================================
//
// WVP automatic transmission model based on ChShaft objects.
//
// =============================================================================
...
// Static variables
const double WVP_AutomaticTransmissionShafts::m_transmissionblock_inertia = 10.5;
const double WVP_AutomaticTransmissionShafts::m_motorshaft_inertia = 0.5;
const double WVP_AutomaticTransmissionShafts::m_driveshaft_inertia = 0.5;
const double WVP_AutomaticTransmissionShafts::m_ingear_shaft_inertia = 0.3;
const double WVP_AutomaticTransmissionShafts::m_upshift_RPM = 2500;
const double WVP_AutomaticTransmissionShafts::m_downshift_RPM = 1200;

WVP_AutomaticTransmissionShafts::WVP_AutomaticTransmissionShafts()
    : ChAutomaticTransmissionShafts("Transmission") {}

void WVP_AutomaticTransmissionShafts::SetGearRatios(std::vector<double>& fwd, double& rev) {
...
void WVP_AutomaticTransmissionShafts::SetTorqueConverterCapacityFactorMap(std::shared_ptr<ChFunction_Recorder>& map) {
    map->AddPoint(0.0, 15);
...
void WVP_AutomaticTransmissionShafts::SetTorqeConverterTorqueRatioMap(std::shared_ptr<ChFunction_Recorder>& map) {
