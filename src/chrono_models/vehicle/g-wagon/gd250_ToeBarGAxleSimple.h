...
#ifndef GD250_GSPRING_AXLE_SIMPLE_H
#define GD250_GSPRING_AXLE_SIMPLE_H
...
class CH_MODELS_API GD250_ToeBarGAxleSimple : public ChToeBarGAxleSimple {
  public:
    GD250_ToeBarGAxleSimple(const std::string& name);
    ~GD250_ToeBarGAxleSimple();
