...
#ifndef CH_TOEBAR_G_AXLE_SIMPLE_H
#define CH_TOEBAR_G_AXLE_SIMPLE_H
...
class CH_MODELS_API ChToeBarGAxleSimple : public ChSuspension {
  public:
    ...
    virtual ~ChToeBarGAxleSimple();

    /// Get the name of the vehicle subsystem template.
    virtual std::string GetTemplateName() const override { return "ToeBarGAxleSimple"; }
  ...
  protected:
    ...
    /// Return the mass of the antirollbar body.
    ...
    /// Return the angular stiffness of the antirollbar shaft.
    virtual double getARBStiffness() const = 0;
    /// Return the angular damping of the antirollbar shaft.
