...
// =============================================================================
//
// Base class for a solid axle suspension with Panhard Rod and two longitudinal links.
...
/// suspension and will be mirrored (reflecting the y coordinates) to construct
/// the right side.
class CH_VEHICLE_API ChGAxle : public ChSuspension {
  public:
    ChGAxle(const std::string& name  ///< [in] name of the subsystem
    );

    virtual ~ChGAxle();

    /// Get the name of the vehicle subsystem template.
    virtual std::string GetTemplateName() const override { return "GAxle"; }
