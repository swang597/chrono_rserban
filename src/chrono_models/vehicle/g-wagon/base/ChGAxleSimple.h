...
#ifndef CH_G_AXLE_SIMPLE_H
#define CH_G_AXLE_SIMPLE_H
...
/// suspension and will be mirrored (reflecting the y coordinates) to construct
/// the right side.
class CH_MODELS_API ChGAxleSimple : public ChSuspension {
  public:
    ChGAxleSimple(const std::string& name  ///< [in] name of the subsystem
    );

    virtual ~ChGAxleSimple();

    /// Get the name of the vehicle subsystem template.
    virtual std::string GetTemplateName() const override { return "GAxleSimple"; }
  ...
  protected:
    ...
    /// Return the radius of the antirollbar body (visualization only).
    ...
    /// Return the moments of inertia of the antirollbar body.
    ...
    std::shared_ptr<ChLinkLockPlanePlane> m_axleTubeGuide;  ///< allows translation Z and rotation X
