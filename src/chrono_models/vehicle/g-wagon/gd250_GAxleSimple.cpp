...
const double GD250_GAxleSimple::m_damperCoefficient = 25591.00572;
...
double GD250_SpringForceRear::evaluate(double time,
                                       double rest_length,
                                       double length,
                                       double vel,
...
// -----------------------------------------------------------------------------
class GD250_ShockForceRear : public ChLinkTSDA::ForceFunctor {
  public:
    GD250_ShockForceRear(double compression_slope,
...
GD250_ShockForceRear::GD250_ShockForceRear(double compression_slope,
                                           double compression_degressivity,
                                           double expansion_slope,
                                           double expansion_degressivity)
...
double GD250_ShockForceRear::evaluate(double time,
                                      double rest_length,
                                      double length,
                                      double vel,
                                      const ChLinkTSDA& link) {
...
GD250_GAxleSimple::GD250_GAxleSimple(const std::string& name) : ChGAxleSimple(name) {
    ...
    m_shockForceCB = chrono_types::make_shared<GD250_ShockForceRear>(
