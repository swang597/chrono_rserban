...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
GD250_Pac02Tire::GD250_Pac02Tire(const std::string& name) : ChPac02Tire(name), m_use_vert_map(false) {}

// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void GD250_Pac02Tire::SetPac02Params() {  // begin of variables set up
    m_use_mode = 3;
...
double GD250_Pac02Tire::GetNormalStiffnessForce(double depth) const {
    if (m_use_vert_map)
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
void GD250_Pac02Tire::AddVisualizationAssets(VisualizationType vis) {
