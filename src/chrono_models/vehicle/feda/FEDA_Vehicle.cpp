...
void FEDA_Vehicle::Create(bool fixed, ChassisCollisionType chassis_collision_type) {
    ...
    m_axles[0]->m_wheels[1] = chrono_types::make_shared<FEDA_WheelLeft>("Wheel_FR");
    m_axles[1]->m_wheels.resize(2);
    m_axles[1]->m_wheels[0] = chrono_types::make_shared<FEDA_WheelLeft>("Wheel_RL");
    m_axles[1]->m_wheels[1] = chrono_types::make_shared<FEDA_WheelLeft>("Wheel_RR");
