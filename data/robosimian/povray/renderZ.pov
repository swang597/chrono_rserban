...
#declare cam_loc    = <2, 2, -0.4>;
#declare cam_lookat = <0, 0, -0.4>;
...
// of body 0 (chassis_loc); note that this assumed body information was saved in the data file.
// Remember to use a right-hand frame coordinate frame with Z up.

//#declare cam_loc = <2 * cos(fnum * 3.14 / 125), 2 * sin(fnum * 3.14 / 125), -0.4>;
