...
int main(int argc, char* argv[]) {
    ...
    pendulumBody1->SetPos_dt(ChVector<>(10, 0, 5));
    // pendulumBody1->SetWvel_par(ChVector<>(0.1*CH_C_PI, 0.0, 0.0));  // Angular velocity in rad/s (90 deg/s) around z-axis
