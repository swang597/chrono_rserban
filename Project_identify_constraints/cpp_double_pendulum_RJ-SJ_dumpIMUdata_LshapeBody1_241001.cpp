...
int main(int argc, char* argv[]) {
    ...
    auto pendulumBody1 = std::make_shared<ChBodyEasyBox>(0.1,2,4, //0.5, 2, 0.5,  // x, y, z dimensions
                                                         75, //3000/(4/0.1),         // density
                                                         true,         // create visualization asset
                                                         false         // no collision geometry
                                                         );
    ...
    pendulumBody2->SetPos(ChVector<>(0, 1, 2));
    ...
    ChFrame<> link_position_abs2(ChVector<>(0, 2, 2));
    ...
    double num_steps = int(25 / step_size);
    const std::string out_dir = GetChronoOutputPath() 
        + "Double_pendulum_RJ_SJ_LshapeBody1_3D_dt" +std::to_string(step_size) 
